...
struct BackgroundElement bge = {bkg_data, 2, bkg_tiles};

struct NarrativeElement elem_0 = {&bge, BACKGROUND};
...
struct NarrativeElement * narratives [9] = {&elem_0, &elem_1, &elem_2, &elem_3, &elem_4, &elem_5, &elem_6, &elem_7, &elem_8};

struct Narrative narrative = {9, narratives};
